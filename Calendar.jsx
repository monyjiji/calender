...
import '../css/Calendar.css'; // Import the CSS file for styling
...
const Calendar = () => {
  ...
  <button className="nav-button1" onClick={handlePreviousMonth}>&lt;</button>
  </div>
  ...
  <div className="nav-button">
 <button className="nav-button2" onClick={handleNextMonth}>&gt;</button> 
 </div>
 </div>
 </div>
